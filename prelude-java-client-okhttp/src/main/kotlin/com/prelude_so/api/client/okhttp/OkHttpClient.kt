...
private constructor(private val okHttpClient: okhttp3.OkHttpClient, private val baseUrl: HttpUrl) :
    ...
    override fun execute(
        ...
        return try {
            ...
            throw PreludeIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
