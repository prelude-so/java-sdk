    ...
    fun create() {
        val notifySendResponse =
            NotifySendResponse.builder()
                ...
                .encoding(NotifySendResponse.Encoding.GSM_7)
                .estimatedSegmentCount(1L)
                .from("YourBrand")
        ...
        assertThat(notifySendResponse.encoding()).contains(NotifySendResponse.Encoding.GSM_7)
        assertThat(notifySendResponse.estimatedSegmentCount()).contains(1L)
