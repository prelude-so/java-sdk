...
class TransactionalSendResponseTest {
    ...
    fun createTransactionalSendResponse() {
      val transactionalSendResponse = TransactionalSendResponse.builder()
          .id("id")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .expiresAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .templateId("template_id")
          .to("to")
          .variables(TransactionalSendResponse.Variables.builder()
      ...
      assertThat(transactionalSendResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(transactionalSendResponse.expiresAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(transactionalSendResponse.variables()).isEqualTo(TransactionalSendResponse.Variables.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
