...
class VerificationServiceAsyncTest {
    ...
    fun create() {
      ...
      val verificationFuture = verificationServiceAsync.create(VerificationCreateParams.builder()
    ...
    fun check() {
      ...
      val responseFuture = verificationServiceAsync.check(VerificationCheckParams.builder()
          .code("12345")
