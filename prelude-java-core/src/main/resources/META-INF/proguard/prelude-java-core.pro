...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class so.prelude.sdk.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class so.prelude.sdk.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class so.prelude.sdk.** {
    <init>(...);
