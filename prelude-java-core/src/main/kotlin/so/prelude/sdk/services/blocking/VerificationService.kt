...
interface VerificationService {
    ...
    /** @see [create] */
    fun create(params: VerificationCreateParams, requestOptions: RequestOptions = RequestOptions.none()): VerificationCreateResponse
    ...
    /** @see [check] */
    fun check(params: VerificationCheckParams, requestOptions: RequestOptions = RequestOptions.none()): VerificationCheckResponse

    /**
     * A view of [VerificationService] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
         ...
         * same as [VerificationService.create].
         */
        @MustBeClosed
        ...
        /** @see [create] */
        @MustBeClosed
        fun create(params: VerificationCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<VerificationCreateResponse>

        /**
         * Returns a raw HTTP response for `post /v2/verification/check`, but is otherwise
         * the same as [VerificationService.check].
         */
        @MustBeClosed
        ...
        /** @see [check] */
        @MustBeClosed
        fun check(params: VerificationCheckParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<VerificationCheckResponse>
    }
}
