...
class VerificationServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : VerificationService {

    private val withRawResponse: VerificationService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): VerificationService.WithRawResponse = withRawResponse

    override fun create(params: VerificationCreateParams, requestOptions: RequestOptions): VerificationCreateResponse =
        // post /v2/verification
        withRawResponse().create(params, requestOptions).parse()

    override fun check(params: VerificationCheckParams, requestOptions: RequestOptions): VerificationCheckResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: VerificationCreateParams, requestOptions: RequestOptions): HttpResponseFor<VerificationCreateResponse> {
        ...
        override fun check(params: VerificationCheckParams, requestOptions: RequestOptions): HttpResponseFor<VerificationCheckResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
