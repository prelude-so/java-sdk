...
class WatchServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : WatchServiceAsync {

    private val withRawResponse: WatchServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): WatchServiceAsync.WithRawResponse = withRawResponse

    override fun feedBack(params: WatchFeedBackParams, requestOptions: RequestOptions): CompletableFuture<WatchFeedBackResponse> =
        // post /v2/watch/feedback
        withRawResponse().feedBack(params, requestOptions).thenApply { it.parse() }

    override fun predict(params: WatchPredictParams, requestOptions: RequestOptions): CompletableFuture<WatchPredictResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun feedBack(params: WatchFeedBackParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WatchFeedBackResponse>> {
        ...
        override fun predict(params: WatchPredictParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<WatchPredictResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
