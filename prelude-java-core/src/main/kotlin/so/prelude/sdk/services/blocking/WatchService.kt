...
interface WatchService {
    ...
    /** @see [feedBack] */
    fun feedBack(params: WatchFeedBackParams, requestOptions: RequestOptions = RequestOptions.none()): WatchFeedBackResponse
    ...
    /** @see [predict] */
    fun predict(params: WatchPredictParams, requestOptions: RequestOptions = RequestOptions.none()): WatchPredictResponse

    /**
     * A view of [WatchService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
        ...
        /** @see [feedBack] */
        @MustBeClosed
        fun feedBack(params: WatchFeedBackParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<WatchFeedBackResponse>

        /**
         * Returns a raw HTTP response for `post /v2/watch/predict`, but is otherwise the
         * same as [WatchService.predict].
         */
        @MustBeClosed
        ...
        /** @see [predict] */
        @MustBeClosed
        fun predict(params: WatchPredictParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<WatchPredictResponse>
    }
}
