 ...
 */
class VerificationManagementSubmitSenderIdParams
private constructor(
    ...
    /** A builder for [VerificationManagementSubmitSenderIdParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            verificationManagementSubmitSenderIdParams: VerificationManagementSubmitSenderIdParams
        ) = apply {
            body = verificationManagementSubmitSenderIdParams.body.toBuilder()
            additionalHeaders =
                verificationManagementSubmitSenderIdParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                verificationManagementSubmitSenderIdParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VerificationManagementSubmitSenderIdParams].
         *
         ...
         */
        fun build(): VerificationManagementSubmitSenderIdParams =
            VerificationManagementSubmitSenderIdParams(
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("senderId", senderId), additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (if (senderId.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerificationManagementSubmitSenderIdParams &&
            body == other.body &&
    ...
    override fun toString() =
        "VerificationManagementSubmitSenderIdParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
