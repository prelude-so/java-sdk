...
class TransactionalSendParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("callback_url") @ExcludeMissing private val callbackUrl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("correlation_id") @ExcludeMissing private val correlationId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("expires_at") @ExcludeMissing private val expiresAt: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("variables") @ExcludeMissing private val variables: JsonField<Variables> = JsonMissing.of(),
        ...
        /** The callback URL. */
        fun callbackUrl(): Optional<String> = Optional.ofNullable(callbackUrl.getNullable("callback_url"))
        ...
        /** The variables to be replaced in the template. */
        fun variables(): Optional<Variables> = Optional.ofNullable(variables.getNullable("variables"))
        ...
        class Builder internal constructor() {
            ...
            /** The callback URL. */
            fun callbackUrl(callbackUrl: JsonField<String>) =
                apply {
            ...
            /** The message expiration date. */
            fun expiresAt(expiresAt: JsonField<String>) =
                apply {
            ...
            /** The variables to be replaced in the template. */
            fun variables(variables: JsonField<Variables>) =
                apply {
        ...
        override fun toString() = "Body{templateId=$templateId, to=$to, callbackUrl=$callbackUrl, correlationId=$correlationId, expiresAt=$expiresAt, from=$from, locale=$locale, variables=$variables, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transactionalSendParams: TransactionalSendParams) =
            apply {
        ...
        /** The callback URL. */
        fun callbackUrl(callbackUrl: String) =
            apply {
        ...
        /** The message expiration date. */
        fun expiresAt(expiresAt: String) =
            apply {
        ...
        /** The variables to be replaced in the template. */
        fun variables(variables: Variables) =
            apply {
    ...
    /** The variables to be replaced in the template. */
    @NoAutoDetect
    class Variables @JsonCreator private constructor(
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(variables: Variables) =
                apply {
    ...
    override fun toString() = "TransactionalSendParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
