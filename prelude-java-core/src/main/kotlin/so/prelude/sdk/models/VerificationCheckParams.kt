...
class VerificationCheckParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{code=$code, target=$target, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(verificationCheckParams: VerificationCheckParams) =
            apply {
    ...
    override fun toString() = "VerificationCheckParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
