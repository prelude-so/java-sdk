...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             *
             * Unlike [ja4Fingerprint], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("ja4_fingerprint")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                /**
                 * The JA4 fingerprint observed for the end-user's connection. Prelude will infer it
                 * automatically when you use our Frontend SDKs (which use Prelude's edge network),
                 * but you can also forward the value if you terminate TLS yourself.
                 */
