...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            status = verificationManagementListSenderIdsResponse.status
            value = verificationManagementListSenderIdsResponse.value
    ...
    internal fun validity(): Int =
        (status.asKnown().getOrNull()?.validity() ?: 0) + (if (value.asKnown().isPresent) 1 else 0)
    ...
    private val hashCode: Int by lazy { Objects.hash(status, value, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "VerificationManagementListSenderIdsResponse{status=$status, value=$value, additionalProperties=$additionalProperties}"
}
