 ...
 */
class WatchFeedBackParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("feedback") @ExcludeMissing private val feedback: JsonField<Feedback> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _feedback(): JsonField<Feedback> = feedback
        ...
        class Builder internal constructor() {
             ...
             * authentic behavior.
             */
            fun feedback(feedback: JsonField<Feedback>) =
                apply {
        ...
        override fun toString() = "Body{feedback=$feedback, target=$target, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(watchFeedBackParams: WatchFeedBackParams) =
            apply {
     ...
     */
    @NoAutoDetect
    class Feedback @JsonCreator private constructor(
    ...
    override fun toString() = "WatchFeedBackParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
