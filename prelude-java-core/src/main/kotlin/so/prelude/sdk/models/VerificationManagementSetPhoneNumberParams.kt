 ...
 * entries or errors. If the phone number already exists in the specified list, the operation will
 * succeed without making any changes.
 *
 * In order to get access to this endpoint, contact our support team.
 */
class VerificationManagementSetPhoneNumberParams
private constructor(
    ...
    /** A builder for [VerificationManagementSetPhoneNumberParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            verificationManagementSetPhoneNumberParams: VerificationManagementSetPhoneNumberParams
        ) = apply {
            action = verificationManagementSetPhoneNumberParams.action
            body = verificationManagementSetPhoneNumberParams.body.toBuilder()
            additionalHeaders =
                verificationManagementSetPhoneNumberParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                verificationManagementSetPhoneNumberParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VerificationManagementSetPhoneNumberParams].
         *
         ...
         */
        fun build(): VerificationManagementSetPhoneNumberParams =
            VerificationManagementSetPhoneNumberParams(
                action,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerificationManagementSetPhoneNumberParams &&
            action == other.action &&
            body == other.body &&
    ...
    override fun toString() =
        "VerificationManagementSetPhoneNumberParams{action=$action, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
