...
@NoAutoDetect
class TransactionalSendResponse @JsonCreator private constructor(
    ...
    fun validate(): TransactionalSendResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transactionalSendResponse: TransactionalSendResponse) =
            apply {
    ...
    override fun toString() = "TransactionalSendResponse{id=$id, createdAt=$createdAt, expiresAt=$expiresAt, templateId=$templateId, to=$to, variables=$variables, callbackUrl=$callbackUrl, correlationId=$correlationId, from=$from, additionalProperties=$additionalProperties}"
}
