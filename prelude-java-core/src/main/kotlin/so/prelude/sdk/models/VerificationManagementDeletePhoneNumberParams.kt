 ...
 *
 * This operation is idempotent - re-deleting the same phone number will not result in errors. If
 * the phone number does not exist in the specified list, the operation will succeed without making
 * any changes.
 *
 * In order to get access to this endpoint, contact our support team.
 */
class VerificationManagementDeletePhoneNumberParams
private constructor(
    ...
    /** A builder for [VerificationManagementDeletePhoneNumberParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            body = verificationManagementDeletePhoneNumberParams.body.toBuilder()
            additionalHeaders =
                verificationManagementDeletePhoneNumberParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                verificationManagementDeletePhoneNumberParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [VerificationManagementDeletePhoneNumberParams].
         *
         ...
         */
        fun build(): VerificationManagementDeletePhoneNumberParams =
            VerificationManagementDeletePhoneNumberParams(
                action,
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("phoneNumber", phoneNumber), additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{phoneNumber=$phoneNumber, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VerificationManagementDeletePhoneNumberParams &&
            action == other.action &&
            body == other.body &&
    ...
    override fun hashCode(): Int =
        Objects.hash(action, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "VerificationManagementDeletePhoneNumberParams{action=$action, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
