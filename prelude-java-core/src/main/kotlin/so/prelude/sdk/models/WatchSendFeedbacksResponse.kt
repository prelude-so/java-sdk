...
private constructor(
    ...
    ) : this(requestId, status, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(watchSendFeedbacksResponse: WatchSendFeedbacksResponse) = apply {
            requestId = watchSendFeedbacksResponse.requestId
            status = watchSendFeedbacksResponse.status
            additionalProperties = watchSendFeedbacksResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WatchSendFeedbacksResponse].
         *
         ...
         */
        fun build(): WatchSendFeedbacksResponse =
    ...
    fun validate(): WatchSendFeedbacksResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "WatchSendFeedbacksResponse{requestId=$requestId, status=$status, additionalProperties=$additionalProperties}"
}
