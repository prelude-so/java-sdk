...
class NotifyGetSubscriptionPhoneNumberResponse
...
private constructor(
    ...
    /** A builder for [NotifyGetSubscriptionPhoneNumberResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            configId = notifyGetSubscriptionPhoneNumberResponse.configId
            phoneNumber = notifyGetSubscriptionPhoneNumberResponse.phoneNumber
            source = notifyGetSubscriptionPhoneNumberResponse.source
            state = notifyGetSubscriptionPhoneNumberResponse.state
            updatedAt = notifyGetSubscriptionPhoneNumberResponse.updatedAt
            reason = notifyGetSubscriptionPhoneNumberResponse.reason
            additionalProperties =
                notifyGetSubscriptionPhoneNumberResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NotifyGetSubscriptionPhoneNumberResponse].
         *
         ...
         */
        fun build(): NotifyGetSubscriptionPhoneNumberResponse =
            NotifyGetSubscriptionPhoneNumberResponse(
     ...
     *   expected type.
     */
    fun validate(): NotifyGetSubscriptionPhoneNumberResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NotifyGetSubscriptionPhoneNumberResponse &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(configId, phoneNumber, source, state, updatedAt, reason, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "NotifyGetSubscriptionPhoneNumberResponse{configId=$configId, phoneNumber=$phoneNumber, source=$source, state=$state, updatedAt=$updatedAt, reason=$reason, additionalProperties=$additionalProperties}"
}
