...
private constructor(
     ...
     * first attempt. For example, `2` allows up to 3 total delivery attempts. Lower values reduce
     * delivery cost on hard-to-reach numbers at the expense of deliverability. When omitted, your
    ...
    /**
     * The preferred channel to be used in priority for message delivery. If the channel is
     * unavailable, the system will fallback to other available channels.
     *
     * @throws PreludeInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    /**
     * Schedule the message for future delivery in RFC3339 format. Marketing messages can be
     * scheduled up to 90 days in advance and will be automatically adjusted for compliance with
     * local time window restrictions.
     *
     * @throws PreludeInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NotifySendParams].
         *
    ...
    /** A builder for [NotifySendParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(notifySendParams: NotifySendParams) = apply {
            body = notifySendParams.body.toBuilder()
            additionalHeaders = notifySendParams.additionalHeaders.toBuilder()
            additionalQueryParams = notifySendParams.additionalQueryParams.toBuilder()
        }
         ...
         * the first attempt. For example, `2` allows up to 3 total delivery attempts. Lower values
         * reduce delivery cost on hard-to-reach numbers at the expense of deliverability. When
        ...
        /**
         * Returns an immutable instance of [NotifySendParams].
         *
         ...
         */
        fun build(): NotifySendParams =
            NotifySendParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * to the first attempt. For example, `2` allows up to 3 total delivery attempts. Lower
             * values reduce delivery cost on hard-to-reach numbers at the expense of
             * deliverability. When omitted, your account's configured default applies.
             */
            ...
            /**
             * Schedule the message for future delivery in RFC3339 format. Marketing messages can be
             * scheduled up to 90 days in advance and will be automatically adjusted for compliance
             * with local time window restrictions.
             */
        ...
        override fun toString() =
            "Body{templateId=$templateId, to=$to, callbackUrl=$callbackUrl, correlationId=$correlationId, document=$document, expiresAt=$expiresAt, from=$from, locale=$locale, maxAutoRetries=$maxAutoRetries, preferredChannel=$preferredChannel, scheduleAt=$scheduleAt, variables=$variables, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NotifySendParams &&
            body == other.body &&
    ...
    override fun toString() =
        "NotifySendParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
