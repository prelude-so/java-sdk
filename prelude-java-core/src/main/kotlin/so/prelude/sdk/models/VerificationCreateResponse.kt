...
@NoAutoDetect
class VerificationCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): VerificationCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(verificationCreateResponse: VerificationCreateResponse) =
            apply {
    ...
    override fun toString() = "VerificationCreateResponse{id=$id, method=$method, status=$status, metadata=$metadata, requestId=$requestId, additionalProperties=$additionalProperties}"
}
