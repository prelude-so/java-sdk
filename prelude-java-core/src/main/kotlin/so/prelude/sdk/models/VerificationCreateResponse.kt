...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is VerificationCreateResponse && id == other.id && metadata == other.metadata && method == other.method && requestId == other.requestId && status == other.status && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(id, metadata, method, requestId, status, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "VerificationCreateResponse{id=$id, metadata=$metadata, method=$method, requestId=$requestId, status=$status, additionalProperties=$additionalProperties}"
}
