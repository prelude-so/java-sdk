...
class PreludeClientImpl(
    ...
    private val withRawResponse: PreludeClient.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val transactional: TransactionalService by lazy { TransactionalServiceImpl(clientOptionsWithUserAgent) }

    private val verification: VerificationService by lazy { VerificationServiceImpl(clientOptionsWithUserAgent) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val transactional: TransactionalService.WithRawResponse by lazy { TransactionalServiceImpl.WithRawResponseImpl(clientOptions) }

        private val verification: VerificationService.WithRawResponse by lazy { VerificationServiceImpl.WithRawResponseImpl(clientOptions) }

        private val watch: WatchService.WithRawResponse by lazy { WatchServiceImpl.WithRawResponseImpl(clientOptions) }
