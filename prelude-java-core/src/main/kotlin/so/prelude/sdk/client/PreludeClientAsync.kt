...
/**
 * A client for interacting with the Prelude REST API asynchronously. You can also
...
interface PreludeClientAsync {
    ...
    /**
     * A view of [PreludeClientAsync] that provides access to raw HTTP responses for
     * each method.
     */
