...
/**
 * A client for interacting with the Prelude REST API synchronously. You can also
...
interface PreludeClient {
    ...
    /**
     * A view of [PreludeClient] that provides access to raw HTTP responses for each
     * method.
     */
