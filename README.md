...
[![Maven Central](https://img.shields.io/maven-central/v/so.prelude.sdk/prelude-java)](https://central.sonatype.com/artifact/so.prelude.sdk/prelude-java/0.8.0)
[![javadoc](https://javadoc.io/badge2/so.prelude.sdk/prelude-java/0.8.0/javadoc.svg)](https://javadoc.io/doc/so.prelude.sdk/prelude-java/0.8.0)
...
The REST API documentation can be found on [docs.prelude.so](https://docs.prelude.so). Javadocs are available on [javadoc.io](https://javadoc.io/doc/so.prelude.sdk/prelude-java/0.8.0).
...
```kotlin
implementation("so.prelude.sdk:prelude-java:0.8.0")
```
