...
[![Maven Central](https://img.shields.io/maven-central/v/so.prelude.sdk/prelude-java)](https://central.sonatype.com/artifact/so.prelude.sdk/prelude-java/0.1.0-beta.1)
...
```kotlin
implementation("so.prelude.sdk:prelude-java:0.1.0-beta.1")
```
