...
[![Maven Central](https://img.shields.io/maven-central/v/so.prelude.sdk/prelude-java)](https://central.sonatype.com/artifact/so.prelude.sdk/prelude-java/0.2.1)
[![javadoc](https://javadoc.io/badge2/so.prelude.sdk/prelude-java/0.2.1/javadoc.svg)](https://javadoc.io/doc/so.prelude.sdk/prelude-java/0.2.1)
...
```kotlin
implementation("so.prelude.sdk:prelude-java:0.2.1")
```
