...
dependencies {
    testImplementation(project(":prelude-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../prelude-java-core/src/main/resources/META-INF/proguard/prelude-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("so.prelude.sdk.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../prelude-java-core/src/main/resources/META-INF/proguard/prelude-java-core.pro",
